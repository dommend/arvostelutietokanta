...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'>Edellinen</a></li>";
		else
		    $pagination.= "<span class='disabled'>Edellinen</span>";   
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'>Seuraava</a></li>";
		else
		    $pagination.= "<li><span class='disabled'>Seuraava</span></li>";
		    $pagination.= "</ul>\n";       
		}
